...
#sed -i 's,GRUB_CMDLINE_LINUX="",GRUB_CMDLINE_LINUX="rootwait ro fsck.fix=yes fsck.repair=yes net.ifnames=0 noresume apparmor=0 systemd.gpt_auto=0 i915.enable_rc6=1 i915.enable_fbc=1 video=DSI-1:panel_orientation=right_side_up intel_idle.max_cstate=2",g' /etc/default/grub
