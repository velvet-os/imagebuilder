...
- the nyan big chromebooks seem to be able to boot from either usb devices and sd cards, but nyan blaze chromebooks seem to only be able to boot from sd cards and not from usb (if might be required to try different ones - older and smaller sd cards might work better than newer and larger ones sometimes) - see also: https://github.com/hexdump0815/u-boot-chainloading-for-arm-chromebooks/issues/1#issuecomment-3348572259
