...
sed -i 's/GRUB_CMDLINE_LINUX=""/GRUB_CMDLINE_LINUX="console=tty0 rootwait ro fsck.fix=yes fsck.repair=yes net.ifnames=0 noresume apparmor=0 efi=novamap,noruntime clk_ignore_unused pd_ignore_unused deferred_probe_timeout=30"/g' /etc/default/grub
